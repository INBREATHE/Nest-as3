...
:: Android packaging
set AND_CERT_NAME="Nest-single-core"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\Nest-single-core.p12
...
set IOS_PROVISION=cert\Nest-single-core.mobileprovision
...
:: Output packages
set DIST_PATH=dist
set DIST_NAME=Nest-single-core
