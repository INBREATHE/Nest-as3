...
public final class DatabaseService implements IServiceLocale
{
	...
	//==================================================================================================
		if(_dbExist == false) {
			const file:File = databaseVO.path != null ? new File(databaseVO.path + "/" + databaseVO.NAME) : File.applicationStorageDirectory.resolvePath(databaseVO.NAME);
			_dbExist = file.exists;
			_sqlConnection = new SQLConnection();
			trace("> Nest -> DB exist:",_dbExist, "at path:",file.nativePath);
...
//			trace("> Nest -> DB QUERY = " + _sqlStatement.text);
...
//			trace("> Nest -> DB QUERY = " + _sqlStatement.text);
	...
	//==================================================================================================
	private function ExecuteStatement(query:String, addLanguage:Boolean = true, classRef:Class = null):void {
	//==================================================================================================
		_sqlStatement = new SQLStatement();
		_sqlStatement.sqlConnection = _sqlConnection;
