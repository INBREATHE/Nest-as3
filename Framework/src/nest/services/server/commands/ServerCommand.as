...
public class ServerCommand extends SimpleCommand
{
	...
	private final function ExecuteServerResponceCommandWithCallback(callback:Object, result:Object):void {
		if(callback != null) this.exec( ApplicationCommand.SERVER_RESPONCE, new ServerResponce(callback, result) );
	}
	 ...
	 * @param cache - метка о кэширование запроса. Кэш-запрос будет автоматически удален если ServerResponce.result.status == ServerStatus.OK
	 */
