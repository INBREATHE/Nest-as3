...
//		trace("> Nest -> ScreenMediator > Handle_RemoveComponentStage", screen);
	...
	*/
	...
	//==================================================================================================
		if(popupCount == 0 && screen.isShow) this.isBackPossible = true;
	}
...
//		trace("> Nest -> ScreenMediator > handleNotification:", notification.getName());
		...
		if(name == _dataNotification) TakeComponentData();
		else if(name == ApplicationNotification.ANDROID_BACK_BUTTON && screen.isShow && isBackPossible) Handle_Android_BackButton();
...
//		trace("> Nest -> ScreenMediator > ContentReady:", screen);
	...
	//==================================================================================================
	protected /*abstract*/ function TakeComponentData():void { }
...
//		trace("> Nest -> ScreenMediator > onReturn:", Screen(viewComponent));
	 ...
	 */
	//==================================================================================================
	public function onPrepare(criteria:Object = null):void {
	//==================================================================================================
//		trace("> Nest -> ScreenMediator > onPrepare:", Screen(viewComponent));
		if(!screen.isBuild) this.getDataForScreen( criteria );
		else ContentReady();
	}
